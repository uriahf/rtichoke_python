...
data_to_adjust = pd.DataFrame({
    "reference_group": ["thin"] * len(probs_cox["thin"]) + ["aft"] * len(probs_cox["thin"]),
    "probs": np.concatenate([probs_cox["thin"], probs_cox["aft"]]),
...
# data_to_adjust = pd.DataFrame({
#     "reference_group": (
#         ["thin"] * len(probs_cox["thin"]) +
#         ["full"] * len(probs_cox["full"]) +
#         ["aft"] * len(probs_cox["aft"])
#     ),
#     "probs": np.concatenate([probs_cox["thin"], probs_cox["full"], probs_cox["aft"]]),
#     "reals": np.concatenate([
#         df_time_to_cancer_dx['reals'],
#         df_time_to_cancer_dx['reals'],
#         df_time_to_cancer_dx['reals']
#     ]),
#     "times": np.concatenate([
#         df_time_to_cancer_dx['ttcancer'],
#         df_time_to_cancer_dx['ttcancer'],
#         df_time_to_cancer_dx['ttcancer']
#     ])
# })
