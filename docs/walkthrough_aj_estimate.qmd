...
# works for now
aj_estimate_data = pl.concat([aj_estimate_competing.select(pl.col("reals")), aj_estimate_adjusted.select(pl.col("reals"))])
...
# aj_data_combinations.select(pl.col("strata")).join(
#   final_adjusted_data_polars.select(pl.col("strata")),
#   on=["strata"]
# )

aj_data_combinations.select(pl.col("strata")).unique().join(
  final_adjusted_data_polars.select(pl.col("strata")).unique(),
  on=["strata"]
)
