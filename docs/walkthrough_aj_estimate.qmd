...
preds_aft = np.squeeze(1 - aft_model.predict_survival_function(new_data, times=[1.5]).iloc[-1].values)
...
# Check if preds_aft and pred_thin are identical
if np.array_equal(preds_aft, pred_thin):
    print("preds_aft and pred_thin are identical in form.")
else:
    print("preds_aft and pred_thin are not identical in form.")
