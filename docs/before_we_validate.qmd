...
long_excluded_df = _excluded_events_df(
    ...
    index = ["fixed_time_horizon"],
    variable_name="state",
    value_name="excluded_count"
).to_dicts()
...
filteredLongExcludedDf = long_excluded_df.filter((d) => d.fixed_time_horizon == timeHorizon_aj_estimate)
...
Plot.plot({
  ...
  marks: [
    Plot.lineY(long_excluded_df, {
      x: "fixed_time_horizon",
      y: "excluded_count",
      stroke: "state",
      curve: "step-after"
    }),
    Plot.dot(long_excluded_df, {
      x: "fixed_time_horizon",
      y: "excluded_count",
      fill: "state",
      r: 2.5,
