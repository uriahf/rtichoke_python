...
long_adjusted_df = _aj_adjusted_events(
    ...
    variable_name="state",
    value_name="aj_estimate"
).sort(pl.col("fixed_time_horizon")).to_dicts()
...
filteredLongAdjustedDf = long_adjusted_df.filter((d) => d.fixed_time_horizon == timeHorizon_aj_estimate)
