...
| Calibration | Supported with matching population keys | Supported | **No default on [create_calibration_curve_times()](../reference/create_calibration_curve_times.md#rtichoke.create_calibration_curve_times)**; pass explicitly | Integer and floating-point values supported |
