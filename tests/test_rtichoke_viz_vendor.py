...
_RELEASE_DIR = "rtichoke-viz-0.22.0"
_SHA256 = "64087fe0284ab2beb6e664dd419504a56000e217eaf403f33559896b67fff94d"
_SOURCE_COMMIT = "e862776e2714dd20a7284bdb9c64c4bbe86962b3"


def test_vendored_rtichoke_viz_v0220_provenance_archive_and_schemas():
    provenance = (_VENDOR / "VENDORED_FROM").read_text()
    assert "release=v0.22.0" in provenance
    assert f"source_commit={_SOURCE_COMMIT}" in provenance
    assert "archive=rtichoke-viz-0.22.0.tar.gz" in provenance
    assert f"sha256={_SHA256}" in provenance

    archive = _VENDOR / "rtichoke-viz-0.22.0.tar.gz"
...
def test_v0220_bundle_keeps_existing_exports_and_prediction_distribution():
