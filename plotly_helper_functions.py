...
# frames=[go.Frame(
#         data=reference_data_list + non_interactive_curve +
#           [create_interactive_marker(
#                 performance_data_ready_for_curve[performance_data_ready_for_curve["reference_group"] == "train"], 
#                 group_colors_vec["train"],
#                 1
#             )] +
#             [create_interactive_marker(
#                 performance_data_ready_for_curve[performance_data_ready_for_curve["reference_group"] == "test"], 
#                 group_colors_vec["test"],
#                 1
#             )])]
