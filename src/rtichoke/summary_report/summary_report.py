...
def _html(payload,sums):
 P=json.dumps(payload,separators=(",",":"),default=str).replace("</","<\\/"); S=json.dumps(sums).replace("</","<\\/"); CAL=calibration_renderer_source()
