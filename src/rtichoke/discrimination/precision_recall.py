...
def create_precision_recall_curve(probs: Dict[str, List[float]], reals: Dict[str, List[int]], by: float = 0.01, stratified_by: str = "probability_threshold", size: Optional[int]= None, color_values: List[str] = ["#1b9e77", "#d95f02", "#7570b3", "#e7298a", "#07004D", "#E6AB02",
...
def plot_precision_recall_curve(performance_data: DataFrame, size: Optional[int]= None, color_values: List[str] = ["#1b9e77", "#d95f02", "#7570b3", "#e7298a", "#07004D", "#E6AB02",
                "#FE5F55", "#54494B", "#006E90", "#BC96E6", "#52050A", "#1F271B", "#BE7C4D",
                "#63768D", "#08A045", "#320A28", "#82FF9E", "#2176FF", "#D1603D", "#585123"], url_api: str = "http://localhost:4242/") -> Figure:
    fig = plot_rtichoke_curve(
            performance_data, 
            size = size,
            color_values = color_values,url_api = url_api,
            curve = "precision recall")
    return fig